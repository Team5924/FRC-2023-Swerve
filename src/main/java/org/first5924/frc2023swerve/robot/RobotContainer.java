...
public class RobotContainer {
  ...
  private final LoggedDashboardChooser<Command> autoModeChooser =
      new LoggedDashboardChooser<>("Auto Mode Chooser");
  ...
  public RobotContainer() {
    ...
    autoModeChooser.addDefaultOption(
        "Shoot and Balance", new ShootAndBalance(drive, pivot, intake));
    autoModeChooser.addDefaultOption(
        "Shoot and Mobility", new ShootAndMobility(drive, pivot, intake));
